...
#wpseoO .topSection{min-height:250px;}
...
<div class="topSection">
	...
	<p class="desc">All of the setting used inside of <em>WordPress SEO by Yoast</em> (setting for sitemap XML and noindex) will be also applied to this HTML sitemap.<br />To fully utilize this plugin it is recomended you <a href="https://wordpress.org/plugins/wordpress-seo/" target="_blank">download</a> and activate Yoast's plugin as well.</p>
...
<p style="text-align:right;">Plugin by Daniel Chase @ <a href="https://riseofweb.com" target="_blank">Rise of the Web</a><br /><small><em>This plugin is not affiliated with WordPress SEO by Yoast.</em></small></p>
</div>
<?php }
